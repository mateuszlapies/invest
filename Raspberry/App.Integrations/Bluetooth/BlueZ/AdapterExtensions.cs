...
namespace Raspberry.App.Integrations.Bluetooth.BlueZ
{
    public static class AdapterExtensions
    {
        ...
        public static Task<string[]> GetRolesAsync(this IAdapter o) => o.GetAsync<string[]>("Roles");
        public static Task<string[]> GetExperimentalFeaturesAsync(this IAdapter o) => o.GetAsync<string[]>("ExperimentalFeatures");

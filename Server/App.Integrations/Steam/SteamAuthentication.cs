...
namespace Server.App.Integrations.Steam
{
    public class SteamAuthentication
    {
        private ILogger<SteamAuthentication> logger;
        private DatabaseContext context;
        private IConfigurationSection section;

        private Uri Uri { get; set; }

        public SteamAuthentication(ILogger<SteamAuthentication> logger, DatabaseContext context)
        {
            this.logger = logger;
